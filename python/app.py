...
@app.route("/auth_key/update", methods=['PUT'])
def put_auth_key():
...
# Function to update the auth key from the config.
...
def update_API_key(new_key, old_key):
    ...
    try:
        ...
        # revert changes just in case anything goes wrong
