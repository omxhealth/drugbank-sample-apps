 ...
 * indications.js
 * 
 * Functions for the indications search page.
 */
...
$(document).ready(function() {
    ...
    // Add blue underline when the search bar is in focus.
    // Piggybacks off of the Selectize.js CSS.
    $("#indication-name").on("focus", function(e) {
        $(".selectize-input").addClass("focus");
    });
    
    // Remove the blue underline when the search bar is out of focus.
    // Piggybacks off of the Selectize.js CSS.
